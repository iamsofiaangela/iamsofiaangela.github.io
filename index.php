                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">I am Angela,<br>
                            <h1 id="wordContainer"></h1>
                            </h1>
                            <p class="lead fw-normal text-muted mb-5">a versatile IT professional
                                with a unique blend of skills</p>
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                                <a class="btn brown active me-lg-3 mb-4 mb-lg-0" href="./resume.php">Resume</a>
                                <a class="btn brown me-lg-3 mb-4 mb-lg-0" href="./projects.php">Projects</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="masthead-device-mockup">
                            <img src="./assets/image/profile.JPG" class="img-thumbnail"
                                style="max-width: 70%; height: 50%" alt="profile">
                        </div>
                    </div>
                </div>
            </div>
